...
import { TopNavigationBar } from './BrandTopNavigationBar';
...
import styles from './BrandHandoffIndex.module.css';
...
export const HandoffIndex = ({ initialPageId = flatPages[0].id }) => {
  ...
  return (
    <div className={`theme-brand ${styles.shell} ${styles.shellCollapsed}`}>
