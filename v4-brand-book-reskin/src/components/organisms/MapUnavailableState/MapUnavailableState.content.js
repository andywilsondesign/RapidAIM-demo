export const mapUnavailableContent = {
  connection: {
    ...
    modalTitle: 'Connection issue: map data is unavailable',
  ...
  onboarding: {
    ...
    modalTitle: 'Setup in progress: your map is being prepared',
  ...
  waitingForData: {
    ...
    modalTitle: 'Waiting for field data',
  ...
  paused: {
    ...
    modalTitle: 'Subscription paused: live map access is paused',
